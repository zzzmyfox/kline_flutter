...
class ChartPainter extends CustomPainter {
  ...
  void _drawLastData(Canvas canvas) {
    ...
    while (startX < max) {
      canvas.drawLine(
          Offset(startX, moveY), Offset(startX + dashWidth, moveY), _paint);
      startX += space;
    }
    ...
    _drawText(
        ...
        movePrice,
        Colors.black,
        Offset(_verticalXList[_verticalXList.length - 1] + dp2px(1.0),
  ...
  void _drawScaleLine(Canvas canvas) {
    ...
    for (int i = 0; i < 5; i++) {
      canvas.drawLine(
          Offset(_leftStart + _horizontalSpace * i, _topStart),
          Offset(_leftStart + _horizontalSpace * i, _bottomEnd - dp2px(6.0)),
          _paint);
  ...
  void _drawMainChartView(Canvas canvas) {
    ...
    _perPriceRectWidth =
        (_verticalXList[_verticalXList.length - 1] - _verticalXList[0]) /
            maxViewDataNum;
    //max and min price
    ...
    for (int i = 0; i < viewDataList.length; i++) {
      viewDataList[i].setLeftStartX(_verticalXList[_verticalXList.length - 1] -
          (viewDataList.length - i) * _perPriceRectWidth);
      viewDataList[i].setRightEndX(_verticalXList[_verticalXList.length - 1] -
          (viewDataList.length - i - 1) * _perPriceRectWidth);
      // max price
    ...
    //price data
    _perPriceRectHeight =
        (_priceChartBottom - _horizontalYList[0]) / (_topPrice - _botPrice);
    _maxPriceY =
        _horizontalYList[0] + (_topPrice - _maxPrice) * _perPriceRectHeight;
    _minPriceY =
        _horizontalYList[0] + (_topPrice - _minPrice) * _perPriceRectHeight;
    //volume data
    _perVolumeRectHeight =
        (_horizontalYList[_horizontalYList.length - 1] - _subViewTopY) /
            _maxVolume;
    // subview
    if (isShowSubview && subviewType == 0) {
      // macd
      ...
      _kHeight =
          (_horizontalYList[_horizontalYList.length - 1] - _subViewTopY) /
              _maxK;
      _dHeight =
          (_horizontalYList[_horizontalYList.length - 1] - _subViewTopY) / maxD;
      _jHeight =
          (_horizontalYList[_horizontalYList.length - 1] - _subViewTopY) / maxJ;
    } else if (isShowSubview && subviewType == 2) {
      _rsiHeight =
          (_horizontalYList[_horizontalYList.length - 1] - _subViewTopY) / 100;
    }
    ...
    for (int i = 0; i < viewDataList.length; i++) {
      ...
      viewDataList[i].setCloseY(_horizontalYList[0] +
          (_topPrice - _closePrice) * _perPriceRectHeight);
      viewDataList[i].setOpenY(
          _horizontalYList[0] + (_topPrice - _openPrice) * _perPriceRectHeight);
      // price rect
      ...
      canvas.drawLine(
          Offset(
              ...
              _maxPriceY +
                  (_maxPrice - viewDataList[i].maxPrice) * _perPriceRectHeight),
          Offset(
              viewDataList[i].leftStartX + _perPriceRectWidth / 2,
              _maxPriceY +
                  (_maxPrice - viewDataList[i].minPrice) * _perPriceRectHeight),
          _paint);
      // volume rect
      ...
      if (isShowSubview && subviewType == 0) {
        ...
        if (macd > 0) {
          ...
          canvas.drawLine(Offset(w, _subviewCenterY - macd * _perMACDHeight),
              Offset(w, _subviewCenterY), _paint);
        } else {
          resetPaintStyle(color: fallColor);
          canvas.drawLine(Offset(w, _subviewCenterY),
  ...
  void _drawBezierCurve(Canvas canvas) {
    ...
    for (int i = 0; i < viewDataList.length; i++) {
      ...
      if (viewDataList[i].volumeMA5 != null) {
        ...
        volumeMa5Pointer.setY(_volumeChartBottom -
            viewDataList[i].volumeMA5 * _perVolumeRectHeight);
      ...
      if (viewDataList[i].volumeMA10 != null) {
        ...
        volumeMa10Pointer.setY(_volumeChartBottom -
            viewDataList[i].volumeMA10 * _perVolumeRectHeight);
      ...
      switch (viewType) {
        case 0:
          ...
          if (viewDataList[i].priceMA5 != null) {
            ...
            priceMa5Pointer.setY(_maxPriceY +
                (_maxPrice - viewDataList[i].priceMA5) * _perPriceRectHeight);
          ...
          if (viewDataList[i].priceMA10 != null) {
            ...
            priceMa10Pointer.setY(_maxPriceY +
                (_maxPrice - viewDataList[i].priceMA10) * _perPriceRectHeight);
          ...
          if (viewDataList[i].priceMA30 != null) {
            ...
            priceMa30Pointer.setY(_maxPriceY +
                (_maxPrice - viewDataList[i].priceMA30) * _perPriceRectHeight);
        ...
        case 1:
          ...
          if (viewDataList[i].bollMB != null) {
            ...
            bollMBPointer.setY(_maxPriceY +
                (_maxPrice - viewDataList[i].bollMB) * _perPriceRectHeight);
          ...
          if (viewDataList[i].bollUP != null) {
            ...
            bollUPPointer.setY(_maxPriceY +
                (_maxPrice - viewDataList[i].bollUP) * _perPriceRectHeight);
          ...
          if (viewDataList[i].bollDN != null) {
            ...
            bollDNPointer.setY(_maxPriceY +
                (_maxPrice - viewDataList[i].bollDN) * _perPriceRectHeight);
      ...
      if (isShowSubview && subviewType == 0) {
        ...
        if (viewDataList[i].dif != null) {
          ...
          difPoint.setX(viewDataList[i].leftStartX + _perPriceRectWidth / 2);
          difPoint.setY(
              _subviewCenterY - (viewDataList[i].dif * _perDifHeight).abs());
        }
  ...
  void _drawMaxAndMinPriceText(Canvas canvas) {
    ...
    if (_maxPriceX + _getTextBounds(_maxPriceText).width + dp2px(5.0) <
        _verticalXList[_verticalXList.length - 1]) {
      _maxPriceTextX = _maxPriceX + dp2px(5.0);
      canvas.drawLine(Offset(_maxPriceX, _maxPriceY),
          Offset(_maxPriceTextX, _maxPriceY), _paint);
    } else {
      _maxPriceTextX =
          _maxPriceX - _getTextBounds(_maxPriceText).width - dp2px(5);
      canvas.drawLine(Offset(_maxPriceX - dp2px(5.0), _maxPriceY),
          Offset(_maxPriceX, _maxPriceY), _paint);
    }
    // max text
    _drawText(
        canvas,
        _maxPriceText,
        Colors.white,
        Offset(_maxPriceTextX,
            _maxPriceY - _getTextBounds(_maxPriceText).height / 2));
    // min price text
    String _minPriceText = formatDataNum(_minPrice);
    double _minPriceTextX;
    if (_minPriceX + _getTextBounds(_minPriceText).width + dp2px(5.0) <
        _verticalXList[_verticalXList.length - 1]) {
      _minPriceTextX = _minPriceX + dp2px(5.0);
      canvas.drawLine(Offset(_minPriceTextX - dp2px(5.0), _minPriceY),
          Offset(_minPriceTextX, _minPriceY), _paint);
    } else {
      _minPriceTextX =
          _minPriceX - _getTextBounds(_minPriceText).width - dp2px(5.0);
      canvas.drawLine(Offset(_minPriceX - dp2px(5.0), _minPriceY),
          Offset(_minPriceX, _minPriceY), _paint);
    }
    // min text
    _drawText(
        canvas,
  ...
  void _drawAbscissaText(Canvas canvas) {
    for (int i = 0; i < _verticalXList.length; i++) {
      if (i == 0 &&
          viewDataList[0].leftStartX <=
              _verticalXList[0] + _perPriceRectWidth / 2 &&
          viewDataList[0].rightEndX > _verticalXList[0]) {
        String timestamp = dateFormat(viewDataList[0].timestamp);
        _drawText(canvas, timestamp, scaleTextColor,
            Offset(_leftStart, _horizontalYList[_horizontalYList.length - 1]));
      } else if (i == _verticalXList.length - 1) {
        String dateTime =
            dateFormat(viewDataList[viewDataList.length - 1].timestamp);
        _drawText(
            canvas,
            dateTime,
            scaleTextColor,
            Offset(_verticalXList[_verticalXList.length - 1] - 10,
                _horizontalYList[_horizontalYList.length - 1]));
      } else {
        for (ChartModel data in viewDataList) {
          if (data.leftStartX <= _verticalXList[i] &&
              data.rightEndX >= _verticalXList[i]) {
            String dateTime = dateFormat(data.timestamp);
            _drawText(
                canvas,
                dateTime,
                scaleTextColor,
                Offset(_verticalXList[i] - 10,
                    _horizontalYList[_horizontalYList.length - 1]));
            break;
          }
        }
  ...
  void _drawOrdinateText(Canvas canvas) {
    ...
    _drawText(canvas, _maxPriceText, scaleTextColor,
        Offset(_rightX, _horizontalYList[0]));
    // min price
    ...
    _drawText(
        ...
        scaleTextColor,
        Offset(
            _rightX, _priceChartBottom - _getTextBounds(_minPriceText).height));
    // average price
    if (!isShowSubview) {
      ...
      _drawText(
          ...
          Offset(
              _verticalXList[_verticalXList.length - 1],
              _horizontalYList[_horizontalYList.length - 1] -
                  _getTextBounds(centerSubviewText).height));
    }
    ...
    _drawText(
        ...
        Offset(
            ...
            _volumeChartBottom -
                _verticalSpace / 2 -
                _getTextBounds(_middleVolume).height / 2 +
                dp2px(5.0)));
    // bottom volume
  ...
  void _drawTopText(Canvas canvas) {
    ...
    if (lastData.priceMA30 != null) {
      _drawText(
          ...
          Offset(
              _leftStart +
                  _getTextBounds(_indexTopTextOne).width +
                  _getTextBounds(_indexTopTextTwo).width +
                  dp2px(10.0),
              _topStart - _getTextBounds(_indexTopTextOne).height - 1));
    }
  }
  ...
  void _drawVolumeText(Canvas canvas) {
    ...
    if (lastData.volume != null) {
      ...
      _drawText(canvas, _volumeText, ma30Color,
          Offset(_verticalXList[0], _priceChartBottom));
    }
    if (lastData.volumeMA5 != null) {
      ...
      _drawText(
          ...
          Offset(
              _verticalXList[0] +
                  _getTextBounds(_volumeText).width +
                  dp2px(5.0),
              _priceChartBottom));
    }
    if (lastData.volumeMA10 != null) {
      ...
      _drawText(
          ...
          Offset(
              _verticalXList[0] +
                  _getTextBounds(_volumeText).width +
                  _getTextBounds(_volumeMA5).width +
                  dp2px(10.0),
              _priceChartBottom));
    }
    ...
    _drawText(canvas, titleText, scaleTextColor,
        Offset(_verticalXList[0], _horizontalYList[4]));
    ...
    if (lastData.macd != null || lastData.k != null || lastData.rs1 != null) {
      _drawText(
          ...
          firstText,
          ma5Color,
          Offset(_verticalXList[0] + _getTextBounds(titleText).width + dp2px(5),
              _horizontalYList[4]));
    }
  ...
  void _drawCrossHairLine(Canvas canvas) {
    ...
    canvas.drawLine(
        Offset(
            lastData.leftStartX + _perPriceRectWidth / 2, _horizontalYList[0]),
        Offset(lastData.leftStartX + _perPriceRectWidth / 2,
            _horizontalYList[_horizontalYList.length - 1]),
        _paint);
    // horizontal line
    resetPaintStyle(color: scaleLineColor);
    ...
    canvas.drawLine(Offset(_verticalXList[0], moveY),
        Offset(_verticalXList[_verticalXList.length - 1], moveY), _paint);
    // bottom label
    Rect bottomRect = Rect.fromLTRB(
        lastData.leftStartX + _perPriceRectWidth / 2 - dp2px(15),
        _bottomEnd - 20,
        lastData.leftStartX + _perPriceRectWidth / 2 + dp2px(15),
        _bottomEnd);
    ...
    _drawText(
        ...
        Offset(
            lastData.leftStartX +
                dp2px(1.0) +
                _perPriceRectWidth / 2 -
                _getTextBounds(moveTime).width / 2,
            _bottomEnd - 15));
    // left label
    String movePrice = setPrecision(lastData.closePrice, 2);
    Rect leftRect = Rect.fromLTRB(
  ...
  void _drawDetails(Canvas canvas) {
    ...
    if (lastData.leftStartX + _perPriceRectWidth / 2 <=
        _verticalXList[_verticalXList.length - 1] / 2) {
      // right
      ...
      canvas.drawLine(
          Offset(
              _verticalXList[_verticalXList.length - 1], _horizontalYList[0]),
          Offset(_verticalXList[_verticalXList.length - 1],
              _horizontalYList[0] + _detailRectHeight),
          _paint);
      canvas.drawLine(
          Offset(
              _verticalXList[_verticalXList.length - 1], _horizontalYList[0]),
          Offset(_verticalXList[_verticalXList.length - 1] - rectWidth,
              _horizontalYList[0]),
          _paint);
      canvas.drawLine(
          Offset(_verticalXList[_verticalXList.length - 1] - rectWidth,
      ...
      for (int i = 0; i < detailTitleCN.length; i++) {
        _drawText(
            ...
            detailTitleCN[i],
            detailTextColor,
            Offset(_verticalXList[_verticalXList.length - 1] - rectWidth + 3,
      ...
      for (int i = 0; i < detailDataList.length; i++) {
        ...
        _drawText(
            ...
            Offset(
                _verticalXList[_verticalXList.length - 1] -
                    _getTextBounds(detailDataList[i]).width -
                    3,
                _horizontalYList[0] + _detailRectHeight / 8 * i));
      }
    } else {
      ...
      canvas.drawLine(
          ...
          Offset(_verticalXList[0] + rectWidth,
              _horizontalYList[0] + _detailRectHeight),
          _paint);
      canvas.drawLine(
          Offset(_verticalXList[0], _horizontalYList[0] + _detailRectHeight),
